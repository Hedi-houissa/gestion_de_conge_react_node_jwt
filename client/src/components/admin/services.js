...
function Services() {
    ...
    const AddService = (e) =>{
        ...
        e.preventDefault();
        axios.post('http://localhost:5000/api/service/add_service',body,{headers}).then((res)=>{
            AddedToast();
        },(error) =>{
    ...
    const UpdateService = (e) => {
        ...
        e.preventDefault();
        axios.post('http://localhost:5000/api/service/update_service',body,{headers}).then((res)=>{
            UpdatedToast();
        },(error)=>{
            console.log(error.response);
        })
    ...
    const DeleteService = (e) => {
        ...
        e.preventDefault();
        axios.post('http://localhost:5000/api/service/delete_service',body,{headers}).then((res)=>{
            DeleteToast();
        },(error)=>{
            console.log(error.response);
        })
