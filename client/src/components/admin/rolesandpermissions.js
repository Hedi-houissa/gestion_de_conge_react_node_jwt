...
function RolesAndPermissions() {
    ...
    const getServices = () =>{
        axios.get('http://localhost:5000/api/service/all', { headers: { 'Content-Type': 'application/json', 'X-Auth-Token': `${localStorage.getItem('token')}` } })
        .then((res) =>{
    ...
    const SearchEmployee = (e) =>{
        ...
        axios.post('http://localhost:5000/api/user/userByName',body,{ headers: { 'Content-Type': 'application/json', 'X-Auth-Token': `${localStorage.getItem('token')}` } }).then((res)=>{
            if(res.status === 200){
    ...
    const AffectEmployee = (e) =>{
        axios.get('http://localhost:5000/api/service/serviceId=' + selectedService,{headers:{'Content-Type':'application/json'}}).then((res)=>{
            let Employeestab = [] ;
            ...
            if(exist === false){
                ...
                axios.post("http://localhost:5000/api/service/push_employee",body).then((res)=>{
    ...
    const PromoteEmployee = (e) =>{
     ...
     if(exist === false){
            const body = {Service_id:selectedService,Employee_id:selectedEmployee.userId};
            axios.post("http://localhost:5000/api/service/promote_employee",body,).then((res)=>{
                console.log(res.data);
            })
        }
    } 
    ...
    const AcceptNotice = (e) =>{
       ...
       axios.post("http://localhost:5000/api/notice/accept_notice",data).then((res)=>{
           console.log(res.data);
       })
    }
    const DenyNotice = (e) =>{
        const data = NoticeData(e);
       axios.post("http://localhost:5000/api/notice/deny_notice",data).then((res)=>{
           console.log(res.data);
       })
    }
    function newFunction(){
         axios.get('http://localhost:5000/api/notice/all', { headers: { 'Content-Type': 'application/json', 'X-Auth-Token': `${localStorage.getItem('token')}` } })
                    .then((res) => {
                        setNotices(res.data);
                    });
            }
