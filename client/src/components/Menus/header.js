        ...
        <Box w="100%" h="25%" display="flex" bg="linear-gradient(90deg, #048B9A 0%, #048B9A 100%);" p={2} alignItems='flex-start' justifyContent="space-between">
            ...
            <Menu flexBasis="40%">
                <MenuButton mx="15px" marginTop={2}>
                    <Avatar name={authContext.user.firstName +' '+ authContext.user.lastName} src={'http://localhost:5000'+authContext.user.picture}><AvatarBadge boxSize='1.25em' bg='green.500'/></Avatar>
                </MenuButton>
                <MenuList>
